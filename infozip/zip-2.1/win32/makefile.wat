...
# using Watcom C/C++ v10.5, by Paul Kienitz, last revised 19 Jan 96.
...
OBJZ1 = $(OBJZ2) $(O)globals.obj $(O)bits.obj $(O)crctab.obj $(asmob)
OBJZ  = $(OBJZ1) $(O)win32zip.obj $(O)win32.obj

OBJ_U = $(O)zipfile_.obj $(O)fileio_.obj $(O)util_.obj $(O)globals.obj
...
$(O)win32zip.obj: win32\win32zip.c $(ZIP_H) win32\win32zip.h
